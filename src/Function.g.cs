...
namespace PdfExporterSample
{
    public class Function
    {
        ...
        private IModelStore<PdfExporterSampleInputs> store;

        public async Task<PdfExporterSampleOutputs> Handler(PdfExporterSampleInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<PdfExporterSampleInputs>(RegionEndpoint.USWest1);
            }

            var l = new ExporterInvocationWrapper<PdfExporterSampleInputs,PdfExporterSampleOutputs>(store, PdfExporterSample.Execute);
